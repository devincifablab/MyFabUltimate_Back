 ...
 */
 ...
 async function getRolesForUserById(data) {
     ...
     if (!data.params.idUser || !data.headers.dvflcookie || isNaN(data.params.idUser)) {
         return {
             type: "code",
             code: 400
         }
 ...
 async function postAddRoleForUser(data) {
     // The body does not have all the necessary field
     if (!data.params.idUser || !data.params.idRole || isNaN(data.params.idUser) || isNaN(data.params.idRole)) {
         return {
             type: "code",
             code: 400
         }
